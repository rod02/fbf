...
public class CommentsItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == FeedAdapter.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((ArticleCommentAdapter.ViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final ArticleCommentAdapter.ViewHolder holder) {
