...
public class SliderLayout extends FrameLayout implements CircularSliderHandle.CurrentPageListener{
    ...
    private void setLayout(Context context) {
        View view = LayoutInflater.from(context).inflate(com.smarteist.autoimageslider.R.layout.slider_layout, this, true);
        mFlippingPager = view.findViewById(com.smarteist.autoimageslider.R.id.vp_slider_layout);
        pagerIndicator = view.findViewById(com.smarteist.autoimageslider.R.id.pager_indicator);
    ...
    public void clearSliderViews(){
        //mFlippingPagerAdapter = new SliderAdapter(getContext());
        //mFlippingPager.setAdapter(mFlippingPagerAdapter);
        removeAllViews();
    }
    public void reset() {
