...
import com.fightbackfoods.adapter.UserProfileAdapter;
import com.fightbackfoods.model.User;
import com.fightbackfoods.utils.CircleTransformation;
import com.fightbackfoods.view.RevealBackgroundView;
...
public class UserProfileActivity extends BaseDrawerActivity implements RevealBackgroundView.OnStateChangeListener {
    ...
    public static void startUserProfileFromLocation(int[] startingLocation, Activity startingActivity, User user) {
        Intent intent = new Intent(startingActivity, UserProfileActivity.class);
        intent.putExtra(ARG_REVEAL_START_LOCATION, startingLocation);
        startingActivity.startActivity(intent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.profilePhoto = user.getAvatar();

        tvProfileName.setText(user.getSimpleName());
        tvProfileEmail.setText(user.getEmail());
      //  tvProfileAbout.setText(user.getUserDetailId());
        Picasso.with(this)
                .load(profilePhoto)
